...
: QWidget(parent), node_(node)
{
  ...
  connect(
    balance_stand_button_, &QPushButton::clicked, this, [this]() {
      onModeChanged("balance_stand");
    });
  ...
  connect(
    recovery_stand_button_, &QPushButton::clicked, this, [this]() {
      onModeChanged("recovery_stand");
    });
  ...
  connect(
    switch_gait_button_, &QPushButton::clicked, this,
    [this]() {onModeChanged("switch_gait");});
  connect(trigger_button_, &QPushButton::clicked, this, [this]() {onModeChanged("trigger");});
  connect(
    body_height_button_, &QPushButton::clicked, this,
    [this]() {onModeChanged("body_height");});
  connect(
    foot_raise_height_button_, &QPushButton::clicked, this, [this]() {
      onModeChanged("foot_raise_height");
    });
  connect(
    speed_level_button_, &QPushButton::clicked, this,
    [this]() {onModeChanged("speed_level");});
  ...
  connect(
    trajectory_follow_button_, &QPushButton::clicked, this, [this]() {
      onModeChanged("trajectory_follow");
    });
  connect(
    continuous_gait_button_, &QPushButton::clicked, this, [this]() {
      onModeChanged("continuous_gait");
    });
  ...
  connect(
    switch_joystick_button_, &QPushButton::clicked, this, [this]() {
      onModeChanged("switch_joystick");
    });
  ...
  connect(
    front_pounce_button_, &QPushButton::clicked, this, [this]() {
      onModeChanged("front_pounce");
    });
  connect(
    wiggle_hips_button_, &QPushButton::clicked, this,
    [this]() {onModeChanged("wiggle_hips");});
  connect(
    economic_gait_button_, &QPushButton::clicked, this, [this]() {
      onModeChanged("economic_gait");
    });
  connect(
    finger_heart_button_, &QPushButton::clicked, this, [this]() {
      onModeChanged("finger_heart");
    });
  ...
  connect(
    hop_spin_left_button_, &QPushButton::clicked, this, [this]() {
      onModeChanged("hop_spin_left");
    });
  connect(
    hop_spin_right_button_, &QPushButton::clicked, this, [this]() {
      onModeChanged("hop_spin_right");
    });
  ...
  connect(
    walk_up_right_button_, &QPushButton::clicked, this, [this]() {
      onModeChanged("walk_up_right");
    });
  ...
  QList<QPushButton *> buttons = {
    ...
    free_jump_button_, free_avoid_button_, walk_stair_button_, walk_up_right_button_,
    cross_step_button_
  };
